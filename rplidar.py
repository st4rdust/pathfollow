r"""Simple and lightweight module for working with RPLidar rangefinder scanner.
...
def _process_scan(raw):
    """Process input raw data and returns measurment data."""
...
class RPLidar(object):
    ...
    def get_health(self):
        ...
        When the core system detects some
    ...
    def stop(self):
        ...
        Disables laser diode and the measurment
    ...
    def reset(self):
        ...
        Reverts it to a similar state as it has
    ...
    def iter_measurments(self, max_buf_meas=500):
        ...
        This is a generator which yields measurements as they come.
        Note that consumer must be fast enough, otherwise data will be
        accumulated inside buffer and consumer will get data with
        increasing lag.
        ...
        """
        # self.start_motor()
        """This line is in the original code but does not allow me to
        change the motor pwm before iterating through measurements."""
    ...
    def iter_scans(self, max_buf_meas=500, min_len=5):
        ...
        This is a generator which yields scans as they come.
        Measurements which do not actually return to the scanner are not
        included in the scans which are yielded.
